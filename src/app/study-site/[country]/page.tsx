...
const sectionLabels = {
  ja: {
    ...
    ctaDesc: "MoveWorthで30カ国以上の移住後の資産推移を無料でシミュレーションしてみよう",
  ...
  en: {
    ...
    living: "Monthly Living Cost (incl. rent)",
    ...
    ctaDesc: "Use MoveWorth to project your assets and living costs in 30+ countries",
  ...
  zh: {
    ...
    ctaTitle: "模拟海外财务状况",
    ctaDesc: "使用MoveWorth免费模拟30多个国家的资产变化和生活成本",
...
export default function StudySiteCountryPage() {
    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50/60 via-white to-slate-50">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-indigo-50 rounded-xl p-4">
              ...
              <p className="text-lg font-bold text-indigo-600 mt-1">
                {formatCost(data.costs.livingMin)} {labels.to} {formatCost(data.costs.livingMax)}
                <span className="text-sm font-normal text-muted">/月</span>
              </p>
            </div>
          </div>
          <p className="text-xs text-muted mt-2">※ 生活費は参考値です。居住エリア・生活スタイルにより大きく異なります。</p>
        </div>
        ...
        <div className="bg-gradient-to-r from-primary to-indigo-600 rounded-2xl p-6 text-white text-center">
          ...
          <h2 className="text-lg font-bold mb-2">{labels.ctaTitle}</h2>
          <p className="text-sm text-white/80 mb-4">{labels.ctaDesc}</p>
          <a
