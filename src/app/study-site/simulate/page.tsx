...
const pageText = {
  ja: {
    ...
    livingLabel: "生活費（現地）",
    totalDisplay: "合計（換算）",
    note: "※ グラフは相対比較用です。正確な金額は各カードをご確認ください。為替レートは参考値のため、実際の費用と差が生じる場合があります。",
  ...
  en: {
    ...
    note: "* This chart is for relative comparison only. Please refer to each card for exact amounts. Exchange rates are approximate and actual costs may vary.",
  ...
  zh: {
    ...
    livingLabel: "生活费（当地）",
    totalDisplay: "合计（换算）",
    note: "※图表仅供相对比较参考，具体金额请查看下方各卡片。汇率为参考值，实际费用可能因汇率及物价变动而有所不同。",
