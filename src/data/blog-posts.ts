...
- 最低給与：年収GBP 41,700（または職種別最低賃金の高い方）（2025年7月改定）
- 有効期間：最大5年
...
| 項目 | 費用 |
|------|------|
| Skilled Worker Visa（海外申請） | GBP 719〜1,751 |
...
- Minimum salary: GBP 41,700/year or going rate for the occupation (revised July 2025)
- Validity: Up to 5 years
- Application fee: GBP 719–1,751 (depending on duration and location)
...
- 要件：大学学位 + 雇用契約 + 最低年収EUR 50,700（2026年）/ IT・不足職種は EUR 45,934
- 有効期間：4年（または雇用期間+3ヶ月）
...
- Requirements: University degree + employment contract + minimum annual salary of EUR 50,700 (2026); EUR 45,934 for IT and shortage occupations
...
- 最低月給（2026年）：
  - 30歳以上：EUR 5,942/月
  - 30歳未満：EUR 4,357/月
  - 大学卒業後1年以内：EUR 3,122/月
- 有効期間：最大3年（更新可）

**EUブルーカード（オランダ）**
HSMの代替として取得可能。最低年収EUR 71,304（2026年）。
...
- Minimum monthly salary (2026):
  - 30 years or older: EUR 5,942/month
  - Under 30 years: EUR 4,357/month
  - Within 1 year of university graduation: EUR 3,122/month
- Validity: Up to 3 years (renewable)

**EU Blue Card (Netherlands)**
Available as an alternative to HSM. Minimum annual salary of EUR 71,304 (2026).
...
**第三国国民クォータ**
スイスは第三国（日本含む）からの外国人就労者に対して年間クォータを設定。L許可は4,000件、B許可は4,500件（2026年。2025年と同数）。ただし、高度人材・専門職は原則的にクォータ内で処理。
...
Switzerland sets annual quotas for workers from outside the EU/EFTA: 4,000 L permits and 4,500 B permits for third-country nationals (2026; unchanged from 2025). Highly skilled professionals are generally processed within these quotas.
...
**第三国公民配额**
瑞士对来自欧盟/欧洲自由贸易联盟以外国家的就业人员设置年度配额：第三国公民可获L许可4,000个、B许可4,500个（2026年，与2025年相同）。高技能专业人才通常在配额内处理。
...
- 最低月収の目安：ポルトガルの最低賃金以上（約€920/月・2025年現在）
- 有効期間：初回2年、更新後3年
- 申請先：最寄りのポルトガル領事館
...
- Minimum income: approx. €920/month (Portugal's minimum wage equivalent, 2025)
...
- 最低月収：€2,850以上（スペイン最低賃金の200%、2026年改定）
...
- Minimum monthly income: €2,850 (200% of Spain's minimum wage, revised 2026)
...
- 最低年収：€40,904以上（2026年3月改定。一部職種は要件が異なる）
...
- Minimum salary: €40,904+ (revised March 2026; varies by occupation)
...
**EUブルーカード（EU Blue Card）**
高度技能者向けのEU共通就労許可。スウェーデンが高度技能職とみなす職種で、月収SEK 52,000以上（年収SEK 624,000以上）が目安（2025年7月改定）。
...
**EU Blue Card**
EU-wide work permit for highly skilled workers. In Sweden, it targets high-skill roles with a salary of at least SEK 52,000/month (SEK 624,000/year; revised July 2025).
...
- Minimum annual salary: DKK 552,000+ (2026)
...
- Minimum annual income: €28,000+ (approx. €2,333/month)
...
- 最低月収：€3,500以上（年収€42,000以上）※2024年4月から引き上げ
- 有効期間：1年間、更新可能
- EU圏外の国籍者が対象
...
- Minimum monthly income: €3,500+ (€42,000/year gross) — increased from €2,700 as of April 2024
- Validity: 1 year, renewable
...
**游民居留许可（数字游民签证）**
- 最低月收入：€3,500以上（年收入€42,000）※2024年4月起调整；有效期：1年，可续签
...
- 「南アフリカ市民で適切な人材がいない」ことの証明が必要（労働市場テスト）
- **2024年10月18日より**：クリティカルスキルビザ・一般就労ビザともにポイント制審査（100点満点）を導入
- 有効期間：最長5年
...
- Employer must demonstrate no suitable South African citizen was available (labour market test)
- **From October 18, 2024**: Both General Work Visa and Critical Skills Visa now use a points-based adjudication system (100 points required)
- Validity: up to 5 years
...
**EU Blue Card**
- Minimum salary: €3,937/month (2026)
...
- **Other Key Workers**: Minimum €3,465/month gross (2026)
- Validity: 2 years, renewable
...
**EU Blue Card**
- Minimum salary: ~CZK 77,245/month (2026)
- Validity: 2 years, renewable
