...
| [🇰🇷 韓国](/blog/study-work-kr) | 週25時間 | 制限緩和 | D-2ビザ所持者対象 |
| [🇸🇬 シンガポール](/blog/study-work-sg) | 週16時間 | 週16時間 | 認可校在籍が条件 |
| [🇲🇾 マレーシア](/blog/study-work-my) | 週20時間（一部業種） | 同左 | 飲食・レジャー業種のみ |
...
| [🇵🇭 フィリピン](/blog/study-work-ph) | 原則禁止 | 原則禁止 | 一部インターンは可 |
| [🇭🇰 香港](/blog/study-work-hk) | 週20時間 | 週20時間 | 認定校在籍が条件 |
| [🇹🇼 台湾](/blog/study-work-tw) | 週16時間 | 週40時間 | 学士課程以上が対象 |
| [🇳🇱 オランダ](/blog/study-work-nl) | 週16時間 | 週40時間 | EUビザとは別要件 |
| [🇨🇭 スイス](/blog/study-work-ch) | 週15時間 | 週15時間 | 語学学校生は対象外の場合も |
| [🇸🇪 スウェーデン](/blog/study-work-se) | 制限なし | 制限なし | EU/EEA圏外は要確認 |
| [🇳🇴 ノルウェー](/blog/study-work-no) | 週20時間 | 週40時間 | 正規課程在籍が条件 |
| [🇩🇰 デンマーク](/blog/study-work-dk) | 週20時間 | 週40時間 | EUブルーカード別途あり |
| [🇫🇮 フィンランド](/blog/study-work-fi) | 制限なし（正規課程） | 制限なし | 語学学校生は週25時間 |
| [🇦🇹 オーストリア](/blog/study-work-at) | 週20時間 | 週20時間 | 学習負担の証明が必要 |
| [🇨🇿 チェコ](/blog/study-work-cz) | 制限なし（EU加盟国外の場合は要確認） | 同左 | 労働許可は不要な場合が多い |
| [🇵🇹 ポルトガル](/blog/study-work-pt) | 週20時間 | 週40時間 | 学生ビザに就労権含む |
| [🇪🇸 スペイン](/blog/study-work-es) | 週20時間 | 週40時間 | Estudiante（学生）ビザ条件 |
| [🇮🇹 イタリア](/blog/study-work-it) | 週20時間 | 週40時間 | Visto per Studio条件 |
| [🇬🇷 ギリシャ](/blog/study-work-gr) | 週20時間 | 週40時間 | EU/EEA学生は自由 |
| [🇮🇪 アイルランド](/blog/study-work-ie) | 週20時間 | 週40時間 | 英語学校生は対象外の場合も |
| 🇧🇪 ベルギー | 制限なし（一部条件あり） | 制限なし | 学生ID提示が必要 |
| [🇲🇹 マルタ](/blog/study-work-mt) | 週16時間 | 週16時間 | 認定校在籍が条件 |
| [🇿🇦 南アフリカ](/blog/study-work-za) | 原則禁止 | 原則禁止 | 就労ビザが別途必要 |
| [🇬🇪 ジョージア](/blog/study-work-ge) | 制限なし | 制限なし | ビザ不要の国籍も多い |
| [🇧🇷 ブラジル](/blog/study-work-br) | 原則禁止 | 原則禁止 | インターンシップは可の場合も |
| [🇨🇴 コロンビア](/blog/study-work-co) | 原則禁止 | 原則禁止 | 就労ビザが別途必要 |
| [🇲🇽 メキシコ](/blog/study-work-mx) | 原則禁止（一部インターン可） | 同左 | 大学間協定による例外あり |
| [🇦🇷 アルゼンチン](/blog/study-work-ar) | 原則禁止 | 原則禁止 | 就労許可が別途必要 |
| [🇨🇳 中国](/blog/study-work-cn) | 原則禁止 | 原則禁止 | X1/X2ビザ所持者は不可 |
...
Only students enrolled at approved institutions can work part-time, up to 16 hours per week during both term time and holidays. Registration on a government job portal is required. Students at non-approved language schools are not permitted to work.
...
**条件：** 飲食店・コンビニ・ホテルなどのサービス業種のみ。専門職（医師・会計士等）は禁止。

### 注意事項

1. 就労可能な業種が限定されているため、事前に確認が必要です
2. 専門職や高度人材向けの業務は学生パスでは認められません
3. 学校側の承認レターが必要な場合があります
...
Students with a Student Pass can work up to 20 hours per week, but only in limited sectors such as restaurants, convenience stores, and hotels. Professional occupations are prohibited. The same 20-hour limit applies during holidays.
...
チェコでは正規課程の学生に就労制限がほとんどありません。

**学期中：** 制限なし
**休暇中：** 制限なし
**条件：** EU/EEA外国籍でも正規課程の学生は就労許可不要。ただし学業に支障がないことが前提。

### 注意事項

1. 正規課程の学生は就労許可なしで働けますが、学業が主目的であることを忘れないようにしましょう
...
| 生活費（月額） | 約CZK10,000〜18,000 |
| 住居費（月額） | 約CZK5,000〜12,000 |
| 学生ビザ申請費 | CZK2,500 |
...
Degree students, including non-EU/EEA nationals, can work without a work permit and with no hour restrictions. However, studies must remain the primary purpose. Visa processing takes 60–120 days, so early preparation is essential. Czech language skills expand job options.
...
中国では学生ビザ所持者の就労は原則禁止されています。

**学期中：** 就労不可
**休暇中：** 就労不可
**条件：** X1/X2ビザ所持者は就労不可。就労するにはZビザ（就労ビザ）への切り替えが必要。

### 注意事項

1. 学生ビザでの就労は一切認められません（アルバイト・パートタイムを含む）
2. 無許可就労が発覚した場合、罰金・拘留・強制帰国の処分を受けます
3. 中国政府奨学金を受給している場合は生活費が支給されることがあります
...
Part-time work is strictly prohibited for students on X1/X2 visas in China. A Z visa (work visa) is required for any employment. Unauthorized work can result in fines, detention, and deportation. Some government scholarship recipients receive living stipends.
...
| 項目 | 費用 |
|------|------|
| 語学学校（月額） | 約ARS50,000〜150,000 |
| 生活費（月額） | 約ARS80,000〜200,000 |
| 住居費（月額） | 約ARS30,000〜100,000 |
| 学生ビザ申請費 | ARS20,000〜（インフレにより変動） |
...
**Fee:** ARS20,000+ (subject to inflation)
**Processing:** 4–8 weeks

### Work Rules

Part-time work is prohibited for students in Argentina. A separate work permit is required for employment. Argentina's high inflation rate means costs fluctuate significantly, and exchange rate differences should be carefully considered.
...
**学期中：** 週16時間まで
**休暇中：** 週16時間まで（学期中と同じ制限）
**条件：** 認定校在籍のみ。Employment Licence（雇用許可）の取得が必要。

### 注意事項

1. 週16時間の制限は休暇中も変わりません
...
Students at approved schools can work up to 16 hours per week during both term and holidays. An Employment Licence is required. Malta's small size means part-time jobs can be competitive.
...
南アフリカでは学生ビザ所持者の就労は原則禁止されています。

**学期中：** 就労不可
**休暇中：** 就労不可
**条件：** 学習のみが目的であり、就労は認められません。

### 注意事項

1. 学生ビザでの就労は一切認められません
...
| 生活費（月額） | 約ZAR6,000〜12,000 |
| 住居費（月額） | 約ZAR3,000〜8,000 |
...
Part-time work is prohibited for students on Study Visas in South Africa. The visa is strictly for study purposes. Students should prepare sufficient funds in advance and pay attention to safety when choosing accommodation.
...
フィンランドでは正規課程の学生に就労制限がほとんどありません。

**学期中：** 制限なし（正規課程の学生）
**休暇中：** 制限なし
**条件：** 正規課程（学位取得目的）の学生は就労時間制限なし。語学学校の学生は週25時間まで。

### 注意事項

1. 語学学校のみの在籍者は週25時間の制限が適用されます
...
Degree students have no work hour restrictions. Language school students are limited to 25 hours per week. A personal identity code (henkilötunnus) is required for employment. Finnish language skills significantly improve job prospects.
...
| 生活費（月額） | 約NOK9,000〜15,000 |
| 住居費（月額） | 約NOK4,000〜9,000 |
| 学生ビザ申請費 | NOK600 |
...
コロンビアでは学生ビザ所持者の就労は原則禁止されています。

**学期中：** 就労不可
**休暇中：** 就労不可
**条件：** 就労するには別途就労ビザの取得が必要です。
...
Part-time work is prohibited for students on student visas in Colombia. A separate work visa is required for employment. Colombia's low cost of living means students can manage without working with proper financial preparation.
...
Students can work up to 20 hours per week during term and 40 hours during holidays. The employer must apply for a work permit, and students need an NIE (foreigner identification number). Self-employment is not permitted on a student visa.
...
ジョージアでは就労に関する制限がほとんどありません。

**学期中：** 制限なし（ほとんどの国籍）
**休暇中：** 制限なし
**条件：** ビザなし滞在の場合も就労が認められるケースが多い。特別な就労許可は不要。

### 注意事項

1. 180日を超える滞在には在留許可の取得が必要です
2. 税務登録が必要な場合があります
3. 最低賃金の規定が緩いため、労働条件は事前に確認しましょう
...
Georgia has virtually no work restrictions for students. Most nationalities can work freely, even on visa-free stays. No special work permit is required. For stays over 180 days, a residence permit is needed.
...
**学期中：** 週15時間まで
**休暇中：** 週15時間まで（学期中と同じ制限）
**条件：** 入学から6ヶ月経過後に就労可能。就労許可を別途取得が必要な場合あり。語学学校のみの在籍者は対象外の場合あり。
...
Students can work up to 15 hours per week after 6 months of enrollment. Language school students may not be eligible. A separate work permit may be required. Switzerland's high cost of living means students should prepare substantial funds.
...
Students at NZQA-approved schools enrolled in full-time courses of 14 weeks or more can work up to 20 hours per week during term and 40 hours during holidays. An IRD number (tax number) is required. Self-employment is not permitted.
...
Students at Designated Learning Institutions (DLIs) can work up to 20 hours per week off-campus during term time and 40 hours during holidays. On-campus work has no hour limit. A Social Insurance Number (SIN) is required. Language school-only students may not qualify for off-campus work.
...
**学期中：** 週16時間まで
**休暇中：** 週40時間まで（夏休み・冬休み）
**条件：** 学士課程以上の在籍が対象。語学センターのみの在籍者は原則就労不可。労働部への就労許可申請が必要。
...
Students enrolled in bachelor's degree programs or higher can work up to 16 hours per week during term time and 40 hours per week during summer and winter holidays. Language center-only students are generally not eligible. A work permit application to the Ministry of Labor is required.
...
| 項目 | 費用 |
|------|------|
| 語学学校（月額） | 約HKD8,000〜15,000 |
| 生活費（月額） | 約HKD8,000〜15,000 |
| 住居費（月額） | 約HKD5,000〜12,000 |
| 学生ビザ申請費 | HKD190 |
...
Students at approved institutions can work up to 20 hours per week during both term time and holidays. An application to the Immigration Department is required. Students at non-approved schools are not eligible for part-time work.
...
| 住居費（月額） | 約IDR1,500,000〜5,000,000 |
| 学生ビザ申請費 | 約USD50 |
...
フィリピンでは学生ビザ所持者の就労は原則禁止されています。

**学期中：** 就労不可
**休暇中：** 就労不可
**条件：** 一部の大学公認インターンシップのみ認められる場合があります。

### 注意事項

1. SSPは「学習のみ」を目的としたビザであり、就労は一切認められません
2. 無許可就労は強制帰国・罰金の対象です
3. 語学学校の寮・食事付きプランを選べば生活費を抑えられます
...
Part-time work is generally prohibited for students in the Philippines. Only certain university-approved internships may be permitted. The SSP is strictly for study purposes, and unauthorized work can result in deportation and fines.
...
| 住居費（月額） | 約VND2,000,000〜6,000,000 |
| 学生ビザ申請費 | USD15〜25 |
...
**学期中：** D-2ビザ所持者は週25時間まで
**休暇中：** 制限緩和（フルタイム可能な場合あり）
**条件：** D-4ビザ（語学研修）所持者は原則就労禁止。D-2ビザでも学業成績（GPA）の条件あり。出入国管理事務所での就労許可申請が必要。

### 注意事項

1. D-4ビザ（語学堂）の学生は原則としてアルバイトが認められません
2. D-2ビザでも一定のGPA（成績）を維持しないと就労許可が取り消されます
3. 就労許可の申請には在学証明書と成績証明書が必要です
...
Work rules depend on visa type. D-2 visa holders can work up to 25 hours per week during term time, with relaxed limits during holidays. D-4 visa (language school) holders are generally prohibited from working. A work permit application at the immigration office is required, and maintaining a minimum GPA is mandatory.
