...
各国の学生ビザの詳細はMoveWorth.studyの「国別就労ルール」記事をご参照ください。
...
| 🇨🇦 カナダ | 週20時間 | 週40時間 | キャンパス内は制限なし |
| 🇬🇧 イギリス | 週20時間 | 週40時間 | Tier 4（学生ビザ） |
| 🇺🇸 アメリカ | キャンパス内週20時間 | キャンパス内週40時間 | キャンパス外は原則不可 |
| 🇳🇿 ニュージーランド | 週20時間 | 週40時間 | 認定校在籍が条件 |
| 🇩🇪 ドイツ | 年120日（フル）または240日（半日） | 同左 | EU内就労も可能 |
| 🇫🇷 フランス | 年964時間以内 | 同左 | 学生ビザに就労権含む |
| 🇯🇵 日本 | 週28時間 | 週40時間（夏冬春休み） | 「資格外活動許可」が必要 |
| 🇰🇷 韓国 | 週25時間 | 制限緩和 | D-2ビザ所持者対象 |
| 🇸🇬 シンガポール | 週16時間 | 週16時間 | 認可校在籍が条件 |
| 🇲🇾 マレーシア | 週20時間（一部業種） | 同左 | 飲食・レジャー業種のみ |
| 🇹🇭 タイ | 原則禁止 | 原則禁止 | 就労ビザが別途必要 |
| 🇻🇳 ベトナム | 原則禁止 | 原則禁止 | 語学ボランティアは可の場合も |
| 🇮🇩 インドネシア | 原則禁止 | 原則禁止 | 就労ビザが必要 |
| 🇵🇭 フィリピン | 原則禁止 | 原則禁止 | 一部インターンは可 |
| 🇭🇰 香港 | 週20時間 | 週20時間 | 認定校在籍が条件 |
| 🇹🇼 台湾 | 週16時間 | 週40時間 | 学士課程以上が対象 |
| 🇳🇱 オランダ | 週16時間 | 週40時間 | EUビザとは別要件 |
| 🇨🇭 スイス | 週15時間 | 週15時間 | 語学学校生は対象外の場合も |
| 🇸🇪 スウェーデン | 制限なし | 制限なし | EU/EEA圏外は要確認 |
| 🇳🇴 ノルウェー | 週20時間 | 週40時間 | 正規課程在籍が条件 |
| 🇩🇰 デンマーク | 週20時間 | 週40時間 | EUブルーカード別途あり |
| 🇫🇮 フィンランド | 制限なし（正規課程） | 制限なし | 語学学校生は週25時間 |
| 🇦🇹 オーストリア | 週20時間 | 週20時間 | 学習負担の証明が必要 |
| 🇨🇿 チェコ | 制限なし（EU加盟国外の場合は要確認） | 同左 | 労働許可は不要な場合が多い |
| 🇵🇹 ポルトガル | 週20時間 | 週40時間 | 学生ビザに就労権含む |
| 🇪🇸 スペイン | 週20時間 | 週40時間 | Estudiante（学生）ビザ条件 |
| 🇮🇹 イタリア | 週20時間 | 週40時間 | Visto per Studio条件 |
| 🇬🇷 ギリシャ | 週20時間 | 週40時間 | EU/EEA学生は自由 |
| 🇮🇪 アイルランド | 週20時間 | 週40時間 | 英語学校生は対象外の場合も |
| 🇧🇪 ベルギー | 制限なし（一部条件あり） | 制限なし | 学生ID提示が必要 |
| 🇲🇹 マルタ | 週16時間 | 週16時間 | 認定校在籍が条件 |
| 🇿🇦 南アフリカ | 原則禁止 | 原則禁止 | 就労ビザが別途必要 |
| 🇺🇦 ジョージア | 制限なし | 制限なし | ビザ不要の国籍も多い |
| 🇧🇷 ブラジル | 原則禁止 | 原則禁止 | インターンシップは可の場合も |
| 🇨🇴 コロンビア | 原則禁止 | 原則禁止 | 就労ビザが別途必要 |
| 🇲🇽 メキシコ | 原則禁止（一部インターン可） | 同左 | 大学間協定による例外あり |
| 🇦🇷 アルゼンチン | 原則禁止 | 原則禁止 | 就労許可が別途必要 |
| 🇨🇳 中国 | 原則禁止 | 原則禁止 | X1/X2ビザ所持者は不可 |
