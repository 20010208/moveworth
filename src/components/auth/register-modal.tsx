      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl border border-border/60 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="px-6 pt-5 pb-2">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-border/60 rounded-xl px-4 py-2.5 text-sm font-medium text-foreground hover:bg-slate-50 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
