...
const COUNTRY_TAX_EXTRA_CONSTRAINTS: Partial<Record<string, Record<Lang, string>>> = {
  ...
  ar: {
    ja: "【AR税制制約（AFIP Art.94 PDF 2025年度確認済み）】アルゼンチンの個人所得税（Impuesto a las Ganancias）は9段階累進税率（Ley N°27.743 Art.94、IPC INDEC指数連動）。2025年度年間課税所得スケール（Tabla Art.94 LIG 2025）：ARS 0〜1,749,901.45が5%・1,749,901.45〜3,499,802.89超過分9%・3,499,802.89〜5,249,704.34超過分12%・5,249,704.34〜7,874,556.52超過分15%・7,874,556.52〜15,749,113.04超過分19%・15,749,113.04〜23,623,669.56超過分23%・23,623,669.56〜35,435,504.34超過分27%・35,435,504.34〜53,153,256.52超過分31%・53,153,256.52超過分35%。このARS金額はCPI（IPC INDEC）連動で四半期ごとに改定されるため、「2025年度確認値。最新は AFIP/ARCA（afip.gob.ar）でご確認ください」と注記すること。ソース：AFIP Tabla-Art-94-LIG-liquidacion-anual-y-final-2025.pdf（afip.gob.ar、2026-07-20確認）。",
    en: "【AR tax constraint (verified from AFIP Art.94 PDF 2025)】Argentina's personal income tax (Impuesto a las Ganancias) has 9 progressive brackets (Ley N°27.743 Art.94, CPI-indexed). 2025 annual income scale (Tabla Art.94 LIG 2025): ARS 0–1,749,901.45: 5%; 1,749,901.45–3,499,802.89: 9% on excess; 3,499,802.89–5,249,704.34: 12%; 5,249,704.34–7,874,556.52: 15%; 7,874,556.52–15,749,113.04: 19%; 15,749,113.04–23,623,669.56: 23%; 23,623,669.56–35,435,504.34: 27%; 35,435,504.34–53,153,256.52: 31%; above 53,153,256.52: 35%. These ARS figures are indexed by CPI (IPC INDEC) and are updated quarterly — always note: 'These are verified 2025 figures; verify latest at AFIP/ARCA (afip.gob.ar)'. Source: AFIP Tabla-Art-94-LIG-liquidacion-anual-y-final-2025.pdf (afip.gob.ar, verified 2026-07-20).",
    zh: "【AR税制约束（AFIP Art.94 PDF 2025年度已验证）】阿根廷个人所得税（Impuesto a las Ganancias）采用9档累进税率（Ley N°27.743第94条，与CPI指数挂钩）。2025年度年度应税所得表（Tabla Art.94 LIG 2025）：ARS 0~1,749,901.45：5%；超出1,749,901.45~3,499,802.89部分：9%；超出3,499,802.89~5,249,704.34：12%；超出5,249,704.34~7,874,556.52：15%；超出7,874,556.52~15,749,113.04：19%；超出15,749,113.04~23,623,669.56：23%；超出23,623,669.56~35,435,504.34：27%；超出35,435,504.34~53,153,256.52：31%；超过53,153,256.52：35%。上述ARS金额与CPI（IPC INDEC）挂钩，每季度更新，须注明「2025年度确认值，最新数据请参阅AFIP/ARCA（afip.gob.ar）」。来源：AFIP Tabla-Art-94-LIG-liquidacion-anual-y-final-2025.pdf（afip.gob.ar，2026-07-20验证）。",
  },
  tr: {
    ja: "【TR税制制約（GIB CDN PDF 2025年度確認済み）】トルコの個人所得税（Gelir Vergisi）累進税率（GVK第103条・2025年適用 / GIB 2025 Gelir Vergisi Tarifesi PDF確認）。5段階の年間課税所得ブラケット：TRY 0〜158,000は15%・158,000〜330,000の超過分20%（158,000 TRY超過に23,700 TRY加算）・330,000〜800,000の超過分27%（330,000 TRY超過に58,100 TRY加算）・800,000〜4,300,000の超過分35%（800,000 TRY超過に185,000 TRY加算）・4,300,000 TRY超過分40%（4,300,000 TRY超過に1,410,000 TRY加算）。【重要・給与所得（ücret gelirleri）特別規定】給与所得の場合、第3ブラケット上限が拡大：27%ブラケットは330,001〜1,200,000 TRL、35%ブラケットは1,200,001〜4,300,000 TRY。「2025年所得適用。ソース：GIB（Gelir İdaresi Başkanlığı）2025 Gelir Vergisi Tarifesi公式PDF」と明記すること。",
    en: "【TR tax constraint (verified from GIB CDN PDF 2025)】Turkey's personal income tax (Gelir Vergisi) progressive brackets (GVK Article 103, applicable to 2025 income / verified from GIB 2025 Gelir Vergisi Tarifesi PDF). 5-bracket annual income scale: TRY 0–158,000: 15%; 158,001–330,000: 20% (plus TRY 23,700 on excess over 158,000); 330,001–800,000: 27% (plus TRY 58,100 on excess over 330,000); 800,001–4,300,000: 35% (plus TRY 185,000 on excess over 800,000); above 4,300,000 TRY: 40% (plus TRY 1,410,000 on excess). IMPORTANT — Special expanded brackets for salary income (ücret gelirleri): 3rd bracket (27%) extends to 1,200,000 TRY; 4th bracket (35%) applies from 1,200,001–4,300,000 TRY. State: 'Applicable to 2025 income. Source: GIB (Gelir İdaresi Başkanlığı) 2025 Gelir Vergisi Tarifesi official PDF'.",
    zh: "【TR税制约束（GIB CDN PDF 2025年度已验证）】土耳其个人所得税（Gelir Vergisi）累进税率（GVK第103条，适用于2025年所得 / 经GIB 2025 Gelir Vergisi Tarifesi PDF验证）。年度应税所得5档税率：TRY 0~158,000：15%；158,001~330,000超出部分：20%（158,000 TRY超出部分加23,700 TRY）；330,001~800,000超出部分：27%（330,000 TRY超出部分加58,100 TRY）；800,001~4,300,000超出部分：35%（800,000 TRY超出部分加185,000 TRY）；超过4,300,000 TRY：40%（超过4,300,000 TRY部分加1,410,000 TRY）。【重要】工资所得（ücret gelirleri）特别规定：第3档（27%）上限扩展至1,200,000 TRY；第4档（35%）适用于1,200,001~4,300,000 TRY。须注明「适用于2025年所得。来源：GIB（税务总局）2025年 Gelir Vergisi Tarifesi 官方PDF」。",
  },
  mx: {
    ja: "【MX税制制約（SAT Anexo8 RMF2025 PDF確認済み）】メキシコのISR（Impuesto Sobre la Renta）年間課税所得税率表（Art.97/152 LISR、SAT Resolución Miscelánea Fiscal 2025 Anexo8、omawww.sat.gob.mx確認済み）。11段階ブラケット：MXN 0〜8,952.49：1.92%・8,952.50〜75,984.55超過分6.40%・75,984.56〜133,536.07超過分10.88%・133,536.08〜155,229.80超過分16.00%・155,229.81〜185,852.57超過分17.92%・185,852.58〜374,837.88超過分21.36%・374,837.89〜590,795.99超過分23.52%・590,796.00〜1,127,926.84超過分30.00%・1,127,926.85〜1,503,902.46超過分32.00%・1,503,902.47〜4,511,707.37超過分34.00%・4,511,707.38以上35.00%。単位は年間MXN（ペソ）。「2025年所得適用（RMF2025 Anexo8、2024年12月30日付Diario Oficial掲載）」と明記すること。",
    en: "【MX tax constraint (verified from SAT Anexo8 RMF2025 PDF)】Mexico's ISR (Impuesto Sobre la Renta) annual income tax rate table (Art.97/152 LISR, SAT Resolución Miscelánea Fiscal 2025 Anexo8, verified via omawww.sat.gob.mx). 11-bracket annual scale in MXN: 0–8,952.49: 1.92%; 8,952.50–75,984.55: 6.40% on excess; 75,984.56–133,536.07: 10.88%; 133,536.08–155,229.80: 16.00%; 155,229.81–185,852.57: 17.92%; 185,852.58–374,837.88: 21.36%; 374,837.89–590,795.99: 23.52%; 590,796.00–1,127,926.84: 30.00%; 1,127,926.85–1,503,902.46: 32.00%; 1,503,902.47–4,511,707.37: 34.00%; above 4,511,707.38: 35.00%. Amounts are annual MXN. State: 'Applicable to 2025 income (RMF2025 Annexe 8, published in Diario Oficial on December 30, 2024)'.",
    zh: "【MX税制约束（SAT Anexo8 RMF2025 PDF已验证）】墨西哥ISR（所得税）年度应税所得税率表（LISR第97/152条，SAT 2025年杂项财政决议Anexo8，经omawww.sat.gob.mx验证）。11档年度应税所得（MXN）：0~8,952.49：1.92%；8,952.50~75,984.55超出部分：6.40%；75,984.56~133,536.07超出部分：10.88%；133,536.08~155,229.80超出部分：16.00%；155,229.81~185,852.57超出部分：17.92%；185,852.58~374,837.88超出部分：21.36%；374,837.89~590,795.99超出部分：23.52%；590,796.00~1,127,926.84超出部分：30.00%；1,127,926.85~1,503,902.46超出部分：32.00%；1,503,902.47~4,511,707.37超出部分：34.00%；超过4,511,707.38：35.00%。金额单位为年度MXN（比索）。须注明「适用于2025年所得（RMF2025附件8，2024年12月30日刊于官方公报）」。",
  },
};
